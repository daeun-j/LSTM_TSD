...
class MulticlassClassification(nn.Module):
    def __init__(self, num_feature, num_class):
        ...
        self.layer_1 = nn.Linear(num_feature,args.l1)
        self.layer_2 = nn.Linear(args.l1, args.l2)
        self.layer_3 = nn.Linear(args.l2, args.l3)
        self.layer_out = nn.Linear(args.l3, num_class)

        self.relu = nn.ReLU()
        self.dropout = nn.Dropout(p=0.2)
        self.batchnorm1 = nn.BatchNorm1d(args.l1)
        self.batchnorm2 = nn.BatchNorm1d(args.l2)
        self.batchnorm3 = nn.BatchNorm1d(args.l3)
