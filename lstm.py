...
name = "jrnl_LSTM_eps{}_merge{}_w{}".format(args.num_epochs, args.MERGE, args.window_size)
...
hyper_params = {"fft": args.fft, "stat" : args.stat, "MERGE" : args.MERGE, "window_size": args.window_size,
                ...
                "num_epochs": args.num_epochs, "split_ratio": args.split_ratio, "layer_dim": args.layer_dim}
"""STEP 2: load data"""
