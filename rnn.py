...
name = "jrnl_RNN_eps{}_merge{}_w{}".format(args.num_epochs, args.MERGE, args.window_size)
...
hyper_params = {"fft": args.fft, "stat" : args.stat, "MERGE" : args.MERGE, "window_size": args.window_size,
                "num_epochs": args.num_epochs, "lr" : args.lr, "batch_size" : args.batch_size,"hidden_dim": args.hidden_dim,
